...
pub const EXTRAS_TEMPLATE_DIR: &str = "extras";
pub const APP_ROUTER_TEMPLATE_DIR: &str = "extras/config/next-config-appdir.js";
pub const TEMPLATE_DIR: &str = "root";
pub const HARDHAT_TEMPLATE_DIR: &str = "hardhat";
pub const OVERWRITE_OPTIONS: [&str; 2] = ["abort", "clear"];
pub const CONFIRM_OPTIONS: [&str; 2] = ["Yes", "No"];
pub const INDEX_MODULE_CSS_TEMPLATE_DIR: &str = "extras/src/index.module.css";
